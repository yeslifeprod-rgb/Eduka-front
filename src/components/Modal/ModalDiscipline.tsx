...
export const ModalDiscipline: React.FC<ModalTestProps> = ({ onClose, selectedDisciplines }) => {
    const [localSelectedDisciplines, setLocalSelectedDisciplines] = useState(selectedDisciplines);
