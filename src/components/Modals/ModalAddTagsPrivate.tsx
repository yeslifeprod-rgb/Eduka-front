...
const ModalAddTagsPrivate: React.FC<ModalAddTagsProps> = ({
  open,
  onClose,
  Tags,
  onSelect,
      ...
      <Box>
        ...
        <section className="absolute bg-white top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-[9999] w-full max-w-md  border rounded-lg shadow-sm m-auto ">
          <div className=" w-full flex items-center py-2 px-2">
            ...
            <h3 className=" text-gray-900 mx-auto text-center mr-16">
              Quel(s) filtre(s) voulez-vous appliquer?
            </h3>
          </div>
          <div className="grid grid-cols-3 justify-center border-2 border-custom-orange rounded-lg mx-2 p-2">
            {Tags.map((category) => (
              <button
                key={category}
                onClick={() =>
                ...
                className={`flex border items-center justify-center border-custom-orange m-2 py-3 px-0 rounded-lg ${
                  selectedTags.includes(category)
          ...
          <div className="mt-4 flex justify-center">
            <button
              ...
              className="w-full border items-center justify-center border-custom-orange bg-custom-orange text-white m-2 py-3 px-0 rounded-lg"
            >
              Valider
            </button>
          </div>
...
export default ModalAddTagsPrivate;
